...
local Window = redzlib:MakeWindow({
  Title = "Nagi Hub : Blox Fruits",
  SubTitle = "by real_nelnagi",
  SaveFolder = "Redz Mod.lua"
})

Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://194720572058", BackgroundTransparency = 0 },
...
TabDiscord:AddDiscordInvite({
    ...
    Logo = "rbxassetid://1957205720",
    Invite = "https://discord.gg/b7eNFdXPS",
})
