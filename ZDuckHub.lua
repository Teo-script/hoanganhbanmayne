...
v225:AddParagraph({
    ["Title"] = "Script made by ZDuck TV",
    ["Content"] = "Thank for use script"
})
v225:AddButton({
    ["Title"] = "Youtube Channel | @ZDuck Roblox",
    ["Description"] = "Click to Copy",
    ["Callback"] = function()
        setclipboard("https://www.youtube.com/@ZDuck_Roblox/")
    end
})
v225:AddButton({
    ...
    ["Description"] = "Click to Copy",
    ["Callback"] = function()
        setclipboard("https://discord.gg/Jdu08Od")
    end
})
local v226 = {
    ["Main"] = v224:AddTab({
...
v227["2"].Image = "rbxassetid://11885570649232"
