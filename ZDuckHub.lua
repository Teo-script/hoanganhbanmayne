...
local v466 = loadstring(game:HttpGet("https://pastefy.app/cgRXe9Xh/raw"))():MakeWindow({
    Title = "ZDuck Hub | Blox Fruits",
    SubTitle = "by ZDuck | Blox Fruits",
...
l_ImageButton_0.Image = "rbxassetid://108610659764941"
...
local v485 = v466:MakeTab({"Farming","rbxassetid://108610659764941"})
local v486 = v466:MakeTab({"Auto Fishing","rbxassetid://108610659764941"})
local v487 = v466:MakeTab({"Quest | Items","rbxassetid://108610659764941"})
local v488 = v466:MakeTab({"Volcano Dojo","rbxassetid://108610659764941"})
local v489 = v466:MakeTab({"Sea Event","rbxassetid://108610659764941"})
local v490 = v466:MakeTab({"Race V4","rbxassetid://108610659764941"})
local v491 = v466:MakeTab({"Raid Fruits,Dungeon","rbxassetid://108610659764941"})
local v492 = v466:MakeTab({"Fruits | Check Stock","rbxassetid://108610659764941"})
local v493 = v466:MakeTab({"Teleport","rbxassetid://108610659764941"})
local v494 = v466:MakeTab({"PvP,Player","rbxassetid://108610659764941"})
local v495 = v466:MakeTab({"Shop","rbxassetid://108610659764941"})
local v496 = v466:MakeTab({"Settings","rbxassetid://108610659764941"})
v484:AddDiscordInvite({
    Name = "Tham Gia Discord",
    Description = "Link Sever Discord",
    Logo = "rbxassetid://108610659764941",
    Invite = " https://discord.gg/ZSfEgf4UrP/"
})
v484:AddDiscordInvite({
    Name = "ZDuck TV",
    Description = "YouTube",
    Logo = "rbxassetid://775769587388",
    Invite = "ko share đâu"
})
v484:AddDiscordInvite({
    Name = "HoangAnh",
    Description = "TikTok Nha Ae",
    Logo = "rbxassetid://775769587388",
    Invite = "ko share luôn"
})
