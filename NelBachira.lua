...
local v466 = loadstring(game:HttpGet("https://pastefy.app/cgRXe9Xh/raw"))():MakeWindow({
    Title = "Bachira Hub : Blox Fruits",
    SubTitle = "by real_bachira",
...
local v484 = v466:MakeTab({"Discord","rbxassetid://112528931029640"})
local v485 = v466:MakeTab({"Farm","rbxassetid://112528931029640"})
local v486 = v466:MakeTab({"Fishing","rbxassetid://112528931029640"})
...
local v490 = v466:MakeTab({"Race-V4","rbxassetid://112528931029640"})
local v491 = v466:MakeTab({"Raid/Fruits","rbxassetid://112528931029640"})
local v492 = v466:MakeTab({"Fruits | Check Stock","rbxassetid://112528931029640"})
local v493 = v466:MakeTab({"Teleport","rbxassetid://112528931029640"})
local v494 = v466:MakeTab({"PvP,Player","rbxassetid://112528931029640"})
local v495 = v466:MakeTab({"Shop","rbxassetid://112528931029640"})
local v496 = v466:MakeTab({"Settings","rbxassetid://112528931029640"})
v484:AddDiscordInvite({
    Name = "Tham Gia Discord",
    Description = "Link Sever Discord",
    Logo = "rbxassetid://112528931029640",
    Invite = " https://discord.gg/Fsofi82jSl"
})
v484:AddDiscordInvite({
    Name = "YoutuBe",
    Description = "Đéo Ai Rảnh Share",
    Logo = "rbxassetid://112528931029640",
    Invite = "ko share đâu"
})
v484:AddDiscordInvite({
    Name = "OFF",
    Description = "TikTok Đây Nhé",
    Logo = "rbxassetid://112528931029640",
    Invite = "tiktok.com/@hoanganhnebanmay"
})
