...
local Window = redzlib:MakeWindow({ Title = "Ninja Hub : Meme Sea", SubTitle = "by hoanganh", SaveFolder = "redzHub-MemeSea.json" })
Window:AddMinimizeButton({
  Button = { Image = "rbxassetid://112528931029640", BackgroundTransparency = 0 },
