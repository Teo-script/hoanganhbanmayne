...
local v466 = loadstring(game:HttpGet("https://pastefy.app/cgRXe9Xh/raw"))():MakeWindow({
    Title = "Green Hub : Blox Fruits",
    SubTitle = "by Green | Blox Fruits",
...
l_ImageButton_0.Image = "rbxassetid://112528931029640"
...
local v484 = v466:MakeTab({"Th\195\180ng Tin | Info","rbxassetid://112528931029640"})
local v485 = v466:MakeTab({"Farming","rbxassetid://112528931029640"})
local v486 = v466:MakeTab({"Auto Fishing","rbxassetid://112528931029640"})
local v487 = v466:MakeTab({"Quest | Items","rbxassetid://112528931029640"})
local v488 = v466:MakeTab({"Volcano Dojo","rbxassetid://112528931029640"})
local v489 = v466:MakeTab({"Sea Event","rbxassetid://112528931029640"})
local v490 = v466:MakeTab({"Race-V4"}),
  "rbxassetid://112528931029640"})
local v491 = v466:MakeTab({"Raid Fruits","rbxassetid://112528931029640"})
local v492 = v466:MakeTab({"Dungeons",
  "rbxassetid://112528931029640"})
local v493 = v466:MakeTab({"Fruits | Check Stock","rbxassetid://112528931029640"})
local v494 = v466:MakeTab({"Teleport","rbxassetid://112528931029640"})
local v495 = v466:MakeTab({"PvP,Player","rbxassetid://112528931029640"})
local v496 = v466:MakeTab({"Shop","rbxassetid://112528931029640"})
local v497 = v466:MakeTab({"Settings","rbxassetid://112528931029640"})
v484:AddDiscordInvite({
    Name = "Tham Gia Discord",
    Description = "Link Sever Discord",
    Logo = "rbxassetid:/10939330201",
    Invite = "https://discord.gg/Hoang-Anh"
})
v484:AddDiscordInvite({
    Name = "Youtube Bố Đây",
    Description = "Cặc",
    Logo = "rbxassetid://112528931029640",
    Invite = "ko share đâu"
})
v484:AddDiscordInvite({
    Name = "Tiktok",
    Description = "TikTok nè m",
    Logo = "rbxassetid://112528931029640",
    Invite = "Cặc đéo share đâu ki"
